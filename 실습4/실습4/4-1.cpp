...
LRESULT CALLBACK WndProc(HWND hWnd, UINT msg, WPARAM wParam, LPARAM lParam)
{
	...
	case WM_COMMAND:
	{
		...
		case ID_GAME_QUIT:
			...
			break;
		case ID_SELECTION_1:
			select1 = true;  select2 = false; select3 = false; select4 = false; 
			break;
		case ID_SELECTION_2:
			select1 = false; select2 = true;  select3 = false; select4 = false; 
			break;
		case ID_SELECTION_3:
			select1 = false; select2 = false; select3 = true;  select4 = false; 
			break;
		case ID_SELECTION_4:
			select1 = false; select2 = false; select3 = false; select4 = true;  
			break;
		...
		case ID_SHAPE_TRIANGLE:
			...
			break;
		case ID_SPEED_FAST:
			if (select1) { timerspeed1 = 100; KillTimer(hWnd, 1); SetTimer(hWnd, 1, timerspeed1, (TIMERPROC)TimerProc1);}
			if (select2) { timerspeed2 = 100; KillTimer(hWnd, 2); SetTimer(hWnd, 2, timerspeed2, (TIMERPROC)TimerProc2); }
			if (select3) { timerspeed3 = 100; KillTimer(hWnd, 3); SetTimer(hWnd, 3 ,timerspeed3, (TIMERPROC)TimerProc3); }
			if (select4) { timerspeed4 = 100; KillTimer(hWnd, 4); SetTimer(hWnd, 4, timerspeed4, (TIMERPROC)TimerProc4); }
			break;
		case ID_SPEED_MEDIUM:
			if (select1) { timerspeed1 = 500; KillTimer(hWnd, 1); SetTimer(hWnd, 1, timerspeed1, (TIMERPROC)TimerProc1); }
			if (select2) { timerspeed2 = 500; KillTimer(hWnd, 2); SetTimer(hWnd, 2, timerspeed2, (TIMERPROC)TimerProc2); }
			if (select3) { timerspeed3 = 500; KillTimer(hWnd, 3); SetTimer(hWnd, 3, timerspeed3, (TIMERPROC)TimerProc3); }
			if (select4) { timerspeed4 = 500; KillTimer(hWnd, 4); SetTimer(hWnd, 4, timerspeed4, (TIMERPROC)TimerProc4); }
			break;
		case ID_SPEED_SLOW:
			if (select1) { timerspeed1 = 5000; KillTimer(hWnd, 1); SetTimer(hWnd, 1, timerspeed1, (TIMERPROC)TimerProc1); }
			if (select2) { timerspeed2 = 5000; KillTimer(hWnd, 2); SetTimer(hWnd, 2, timerspeed2, (TIMERPROC)TimerProc2); }
			if (select3) { timerspeed3 = 5000; KillTimer(hWnd, 3); SetTimer(hWnd, 3, timerspeed3, (TIMERPROC)TimerProc3); }
			if (select4) { timerspeed4 = 5000; KillTimer(hWnd, 4); SetTimer(hWnd, 4, timerspeed4, (TIMERPROC)TimerProc4); }
			break;
		case ID_COLOR_CYAN:
			if (select1) { DeleteObject(gongjeon1); gongjeon1 = CreateSolidBrush(RGB(0, 255, 255)); }
			if (select2) { DeleteObject(gongjeon2); gongjeon2 = CreateSolidBrush(RGB(0, 255, 255)); }
			if (select3) { DeleteObject(gongjeon3); gongjeon3 = CreateSolidBrush(RGB(0, 255, 255)); }
			if (select4) {DeleteObject(gongjeon4); gongjeon4 = CreateSolidBrush(RGB(0, 255, 255));}
			break;
		case ID_COLOR_MAGENTA:
			if (select1) { DeleteObject(gongjeon1); gongjeon1 = CreateSolidBrush(RGB(255, 0, 255)); }
			if (select2) { DeleteObject(gongjeon2); gongjeon2 = CreateSolidBrush(RGB(255, 0, 255)); }
			if (select3) { DeleteObject(gongjeon3); gongjeon3 = CreateSolidBrush(RGB(255, 0, 255)); }
			if (select4) { DeleteObject(gongjeon4); gongjeon4 = CreateSolidBrush(RGB(255, 0, 255)); }
			break;
		case ID_COLOR_YELLOW:
			if (select1) { DeleteObject(gongjeon1); gongjeon1 = CreateSolidBrush(RGB(255, 255, 0)); }
			if (select2) { DeleteObject(gongjeon2); gongjeon2 = CreateSolidBrush(RGB(255, 255, 0)); }
			if (select3) { DeleteObject(gongjeon3); gongjeon3 = CreateSolidBrush(RGB(255, 255, 0)); }
			if (select4) { DeleteObject(gongjeon4); gongjeon4 = CreateSolidBrush(RGB(255, 255, 0)); }
			break;
		}
		return 0;
	}
